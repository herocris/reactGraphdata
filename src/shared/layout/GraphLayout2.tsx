...
import { AccountCircle, Logout, Person, RecentActors, ContactEmergency, Inventory2, FormatListBulleted,HomeRepairServiceOutlined,Vaccines,AllInbox,Category } from '@mui/icons-material';
...
export const GrapLayout2 = ({ children, title = '', window }: GrapLayoutProps) => {
